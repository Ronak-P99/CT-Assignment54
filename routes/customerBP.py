...
from controllers.customerController import save, find_all, find_customers_gmail, find_all_pagination, get_customers_orders
...
customer_bluprint.route('/price-total', methods=['GET'])(get_customers_orders)
